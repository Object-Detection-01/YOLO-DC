...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default='E://DL//ultralytics-xcz//ultralytics//runs//detect//train_DCN_all_3002//weights//best.pt', help='training model path')
    parser.add_argument('--data', type=str, default='../datasets/RUOD.yaml', help='data yaml  path')
